...
const { registerSystem } = require('../core/system.js');
const utils = require('../utils/index.js');
const { setTextureProperties, createCompatibleTexture } = require('../utils/material.js');
 ...
 */
var System = registerSystem('material', {
  init: function () {
    this.materials = {};
    this.sourceCache = {};
  },
