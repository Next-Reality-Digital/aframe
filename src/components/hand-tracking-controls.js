...
module.exports.Component = registerComponent('hand-tracking-controls', {
  ...
  init: function () {
    ...
    // [METAVERSE] Prevent the hands hiding other objects in the same entity
  ...
  updateReferenceSpace: function () {
    console.log("updateReferenceSpace for tracked-controls");
    var self = this;
  ...
  updateWristObject: (function () {
    ...
    return function () {
      ...
      wristObject3D.matrixNeedsUpdate = true;
    };
  })(),
